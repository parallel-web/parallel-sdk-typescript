...
describe('resource findall', () => {
  ...
  test('entitySearch: only required params', async () => {
    const responsePromise = client.beta.findall.entitySearch({
      entity_type: 'people',
      objective: 'objective',
    });
    const rawResponse = await responsePromise.asResponse();
  ...
  test('entitySearch: required and optional params', async () => {
